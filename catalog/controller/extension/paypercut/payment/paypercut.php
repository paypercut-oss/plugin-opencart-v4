...
class Paypercut extends \Opencart\System\Engine\Controller
{
     ...
     * order total (matches the Magento/PrestaShop/OpenCart-v2/v3 Paypercut schema).
     */
    ...
    private function sendPaymentRequest($data)
    {
        ...
        try {
            ...
            // $data['amount'] is already in the smallest currency unit (cents) — see buildCheckoutData()
